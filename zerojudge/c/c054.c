...
int main()
{
	...
	while (gets(str))
	{
		...
		for (i = 0; i < len; i++) {
			if (str[i]=='1') printf("`");
			else if(str[i]=='2') printf("1");
			else if(str[i]=='3') printf("2");
			else if(str[i]=='4') printf("3");
			else if(str[i]=='5') printf("4");
			else if(str[i]=='6') printf("5");
			else if(str[i]=='7') printf("6");
			else if(str[i]=='8') printf("7");
			else if(str[i]=='9') printf("8");
